...
function showQuestion(quesNum) {
  swiper = new Swiper(
    `#chap5-team-game2 .swiper.choices-ques-${quesNum}`,
    {
  ...
  gameQuestion.html(window[`game2-question-${quesNum}`]);
  $(`.ques${quesNum}-ans1`).html(window[`game2-ques${quesNum}-ans1`]);
  $(`.ques${quesNum}-ans2`).html(window[`game2-ques${quesNum}-ans2`]);
  $(`.ques${quesNum}-ans3`).html(window[`game2-ques${quesNum}-ans3`]);
  $(`.ques${quesNum}-ans4`).html(window[`game2-ques${quesNum}-ans4`]);
}
