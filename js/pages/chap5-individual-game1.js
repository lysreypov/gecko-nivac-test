...
function gameHandle() {
  ...
  $(".btn-validate").on("click", function () {
    ...
    if (quesNum < 5) {
      ...
      $(this).offClick();
      _goto("chap5-individual-result1");
    }
  });
}
...
function showQuestion(quesNum) {
  swiper = new Swiper(
    `#chap5-individual-game1 .swiper.choices-ques-${quesNum}`,
    {
  ...
  gameQuestion.html(window[`game1-question-${quesNum}`]);
  $(`.ques${quesNum}-ans1`).html(window[`game1-ques${quesNum}-ans1`]);
  $(`.ques${quesNum}-ans2`).html(window[`game1-ques${quesNum}-ans2`]);
  $(`.ques${quesNum}-ans3`).html(window[`game1-ques${quesNum}-ans3`]);
  $(`.ques${quesNum}-ans4`).html(window[`game1-ques${quesNum}-ans4`]);
}
